 ...
 */
final class Version20240702045157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE family (id INT NOT NULL, person1_id INT DEFAULT NULL, person2_id INT DEFAULT NULL, INDEX IDX_A5E6215B3EF5821B (person1_id), INDEX IDX_A5E6215B2C402DF5 (person2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE individual (id INT NOT NULL, child_to_family_id INT DEFAULT NULL, sex VARCHAR(255) DEFAULT NULL, INDEX IDX_8793FC172EF108B3 (child_to_family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE individual_events (id INT AUTO_INCREMENT NOT NULL, birth_detail_id INT DEFAULT NULL, death_detail_id INT DEFAULT NULL, individual_id INT DEFAULT NULL, death VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8CB518A97ED54915 (birth_detail_id), UNIQUE INDEX UNIQ_8CB518A97F17C6DE (death_detail_id), INDEX IDX_8CB518A9AE271C0D (individual_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE individual_events ADD CONSTRAINT FK_8CB518A97ED54915 FOREIGN KEY (birth_detail_id) REFERENCES individual_event_detail (id)');
        $this->addSql('ALTER TABLE individual_events ADD CONSTRAINT FK_8CB518A97F17C6DE FOREIGN KEY (death_detail_id) REFERENCES individual_event_detail (id)');
