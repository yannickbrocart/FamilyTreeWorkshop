...
class __TwigTemplate_d0e1fa8b7fb16d73bca8ea1c1fcb1322 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 8
        echo "    <div class='container mx-3 mt-5'>
        <h3>Hello ";
        // line 9
        ...
        <a href=\"";
        // line 12
        echo twig_escape_filter($this->env, ("http://localhost:4200/resetpassword/" . twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 12, $this->source); })()), "token", [], "any", false, false, false, 12)), "html", null, true);
        echo "\">
            ";
        // line 13
        echo twig_escape_filter($this->env, ("http://localhost:4200/resetpassword/token:" . twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 13, $this->source); })()), "token", [], "any", false, false, false, 13)), "html", null, true);
        echo "</a>.</p>
...
";
    ...
    {
        return array (  107 => 14,  103 => 13,  99 => 12,  93 => 9,  90 => 8,  80 => 7,  59 => 3,  36 => 1,);
    }
...
{% endblock %}", "reset_password/reset_email.html.twig", "C:\\wamp64\\www\\projet\\FamilyTreeWorkshop\\back_end\\templates\\reset_password\\reset_email.html.twig");
    }
}
