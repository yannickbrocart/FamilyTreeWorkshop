...
{
    /**
     * Gets the private 'App\Repository\TopLevelDataTypes\HeaderRepository' shared autowired service.
     *
     * @return \App\Repository\TopLevelDataTypes\HeaderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TopLevelDataTypes'.\DIRECTORY_SEPARATOR.'HeaderRepository.php';

        return $container->privates['App\\Repository\\TopLevelDataTypes\\HeaderRepository'] = new \App\Repository\TopLevelDataTypes\HeaderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
