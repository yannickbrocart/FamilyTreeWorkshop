 ...
 */
class getIndividualEventRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComponentLevelDataTypes\IndividualEventRepository' shared autowired service.
     *
     * @return \App\Repository\ComponentLevelDataTypes\IndividualEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComponentLevelDataTypes'.\DIRECTORY_SEPARATOR.'IndividualEventRepository.php';

        return $container->privates['App\\Repository\\ComponentLevelDataTypes\\IndividualEventRepository'] = new \App\Repository\ComponentLevelDataTypes\IndividualEventRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
