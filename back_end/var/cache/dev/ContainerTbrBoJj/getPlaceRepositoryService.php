...
{
    /**
     * Gets the private 'App\Repository\ComponentLevelDataTypes\PlaceRepository' shared autowired service.
     *
     * @return \App\Repository\ComponentLevelDataTypes\PlaceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComponentLevelDataTypes'.\DIRECTORY_SEPARATOR.'PlaceRepository.php';

        return $container->privates['App\\Repository\\ComponentLevelDataTypes\\PlaceRepository'] = new \App\Repository\ComponentLevelDataTypes\PlaceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
