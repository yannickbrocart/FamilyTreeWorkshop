 ...
 */
class getIndividualEventDetailRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComponentLevelDataTypes\IndividualEventDetailRepository' shared autowired service.
     *
     * @return \App\Repository\ComponentLevelDataTypes\IndividualEventDetailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComponentLevelDataTypes'.\DIRECTORY_SEPARATOR.'IndividualEventDetailRepository.php';

        return $container->privates['App\\Repository\\ComponentLevelDataTypes\\IndividualEventDetailRepository'] = new \App\Repository\ComponentLevelDataTypes\IndividualEventDetailRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
