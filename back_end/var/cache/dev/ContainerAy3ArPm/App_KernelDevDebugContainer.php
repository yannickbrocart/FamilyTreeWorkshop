...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Files\\ImportGedcomFileController' => 'getImportGedcomFileControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('E1yTWpJoyh', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oB50vqJ6ii', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ELLQz3ROZT', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QSe2tmF4zb', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\ComponentLevelDataTypes\\EventDetailRepository' => ['privates', 'App\\Repository\\ComponentLevelDataTypes\\EventDetailRepository', 'getEventDetailRepositoryService', true],
            'App\\Repository\\ComponentLevelDataTypes\\IndividualEventDetailRepository' => ['privates', 'App\\Repository\\ComponentLevelDataTypes\\IndividualEventDetailRepository', 'getIndividualEventDetailRepositoryService', true],
            'App\\Repository\\ComponentLevelDataTypes\\IndividualEventsRepository' => ['privates', 'App\\Repository\\ComponentLevelDataTypes\\IndividualEventsRepository', 'getIndividualEventsRepositoryService', true],
            'App\\Repository\\ComponentLevelDataTypes\\NamePieceRepository' => ['privates', 'App\\Repository\\ComponentLevelDataTypes\\NamePieceRepository', 'getNamePieceRepositoryService', true],
            'App\\Repository\\ComponentLevelDataTypes\\NameRepository' => ['privates', 'App\\Repository\\ComponentLevelDataTypes\\NameRepository', 'getNameRepositoryService', true],
            'App\\Repository\\ComponentLevelDataTypes\\PlaceRepository' => ['privates', 'App\\Repository\\ComponentLevelDataTypes\\PlaceRepository', 'getPlaceRepositoryService', true],
            'App\\Repository\\GedcomRepository' => ['privates', 'App\\Repository\\GedcomRepository', 'getGedcomRepositoryService', true],
            ...
            'App\\Repository\\TopLevelDataTypes\\FamilyRepository' => ['privates', 'App\\Repository\\TopLevelDataTypes\\FamilyRepository', 'getFamilyRepositoryService', true],
            'App\\Repository\\TopLevelDataTypes\\HeaderRepository' => ['privates', 'App\\Repository\\TopLevelDataTypes\\HeaderRepository', 'getHeaderRepositoryService', true],
            'App\\Repository\\TopLevelDataTypes\\IndividualRepository' => ['privates', 'App\\Repository\\TopLevelDataTypes\\IndividualRepository', 'getIndividualRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\ComponentLevelDataTypes\\EventDetailRepository' => '?',
            'App\\Repository\\ComponentLevelDataTypes\\IndividualEventDetailRepository' => '?',
            'App\\Repository\\ComponentLevelDataTypes\\IndividualEventsRepository' => '?',
            'App\\Repository\\ComponentLevelDataTypes\\NamePieceRepository' => '?',
            'App\\Repository\\ComponentLevelDataTypes\\NameRepository' => '?',
            'App\\Repository\\ComponentLevelDataTypes\\PlaceRepository' => '?',
            'App\\Repository\\GedcomRepository' => '?',
            'App\\Repository\\ResetPasswordRequestRepository' => '?',
            'App\\Repository\\TopLevelDataTypes\\FamilyRepository' => '?',
            'App\\Repository\\TopLevelDataTypes\\HeaderRepository' => '?',
            'App\\Repository\\TopLevelDataTypes\\IndividualRepository' => '?',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\DataController', 'App\\Controller\\Files\\ImportGedcomFileController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ResetPasswordController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ux4FWoUZPX', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('+NjdIc-wPA', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kYQ1WMKp0p', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QJYkUMKsck', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a9bn-DNwvT', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0jTIVRQTli', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $container->privates['router.request_context'] = $instance = \Symfony\Component\Routing\RequestContext::fromUri('http://localhost:4200', 'localhost', 'http', 80, 443);
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.api' => ($container->privates['.security.request_matcher.yy_ZK6T'] ?? $container->load('get_Security_RequestMatcher_YyZK6TService'));
        }, 3));
    }
