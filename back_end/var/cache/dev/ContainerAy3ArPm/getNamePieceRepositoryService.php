 ...
 */
class getNamePieceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComponentLevelDataTypes\NamePieceRepository' shared autowired service.
     *
     * @return \App\Repository\ComponentLevelDataTypes\NamePieceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComponentLevelDataTypes'.\DIRECTORY_SEPARATOR.'NamePieceRepository.php';

        return $container->privates['App\\Repository\\ComponentLevelDataTypes\\NamePieceRepository'] = new \App\Repository\ComponentLevelDataTypes\NamePieceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
