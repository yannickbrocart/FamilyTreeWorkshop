 ...
 */
class getEventDetailRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComponentLevelDataTypes\EventDetailRepository' shared autowired service.
     *
     * @return \App\Repository\ComponentLevelDataTypes\EventDetailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComponentLevelDataTypes'.\DIRECTORY_SEPARATOR.'EventDetailRepository.php';

        return $container->privates['App\\Repository\\ComponentLevelDataTypes\\EventDetailRepository'] = new \App\Repository\ComponentLevelDataTypes\EventDetailRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
