 ...
 */
class getFamilyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TopLevelDataTypes\FamilyRepository' shared autowired service.
     *
     * @return \App\Repository\TopLevelDataTypes\FamilyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TopLevelDataTypes'.\DIRECTORY_SEPARATOR.'FamilyRepository.php';

        return $container->privates['App\\Repository\\TopLevelDataTypes\\FamilyRepository'] = new \App\Repository\TopLevelDataTypes\FamilyRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
