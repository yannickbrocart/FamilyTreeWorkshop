 ...
 */
class getIndividualEventsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComponentLevelDataTypes\IndividualEventsRepository' shared autowired service.
     *
     * @return \App\Repository\ComponentLevelDataTypes\IndividualEventsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComponentLevelDataTypes'.\DIRECTORY_SEPARATOR.'IndividualEventsRepository.php';

        return $container->privates['App\\Repository\\ComponentLevelDataTypes\\IndividualEventsRepository'] = new \App\Repository\ComponentLevelDataTypes\IndividualEventsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
