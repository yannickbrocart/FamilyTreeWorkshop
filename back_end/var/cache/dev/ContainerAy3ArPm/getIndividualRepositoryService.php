 ...
 */
class getIndividualRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TopLevelDataTypes\IndividualRepository' shared autowired service.
     *
     * @return \App\Repository\TopLevelDataTypes\IndividualRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TopLevelDataTypes'.\DIRECTORY_SEPARATOR.'IndividualRepository.php';

        return $container->privates['App\\Repository\\TopLevelDataTypes\\IndividualRepository'] = new \App\Repository\TopLevelDataTypes\IndividualRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
